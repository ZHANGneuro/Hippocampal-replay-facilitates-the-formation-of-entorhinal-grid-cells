...
np.save(fig_export_path+ '/' + str(task_type) + '_' + str(len(angle_offsets)) + 'dir_' + 'step' + str(iter_step) + '.npy', grid_cell_ensemble)

np.save('/ssd_data/anacoda3/envs/size' + str(n) + '_' + str(task_type) + '_' + str(
    len(angle_offsets)) + 'dir_x.npy', np.array(coor_x))
np.save('/ssd_data/anacoda3/envs/size' + str(n) + '_' + str(task_type) + '_' + str(
    len(angle_offsets)) + 'dir_y.npy', np.array(coor_y))
