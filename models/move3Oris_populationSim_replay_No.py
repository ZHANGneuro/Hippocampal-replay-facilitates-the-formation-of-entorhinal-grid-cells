...
task_type = 'subjects_replay_no_2'
...
# n = 45
# aaa = np.load('/ssd_data/anacoda3/envs/subjects_replay_no_2/sub3_size45_subjects_replay_no_2_3dir_step330_stepsize3.npy')
# aaa = aaa.reshape(4, n, n)
# plt.close('all')
